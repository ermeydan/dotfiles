...
require("lazy").setup({
...

  {
    ...
    config = function()
      ...
      vim.keymap.set("n", "<leader>-", "<cmd>NvimTreeFindFileToggle<cr>", { desc = "[-] Open Tree" })
    end,
  },
  {
    "github/copilot.vim",
...
require("nvim-treesitter.configs").setup({
  ...
  ensure_installed = { "html", "css", "json", "scss", "lua", "python", "tsx", "javascript", "typescript", "vim" },
...
vim.keymap.set("i", "j<space>", "j", { noremap = true })
...
-- close quick fix window after enter selection
vim.api.nvim_create_autocmd("FileType", {
  pattern = { "qf" },
